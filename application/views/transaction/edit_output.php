    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <!-- form upload ci -->
                <?= form_open_multipart('transaction/updateOutput'); ?>


                <input type="hidden" class="form-control" name="code" id="code" value="<?= $data->code; ?>">
                <input type="hidden" class="form-control" name="is_approved" id="is_approved" value="0">
                        ...
                        <div class="col-sm-10">
                            ...
                            <select id="code_item" name="code_item" class="form-control chosen">
                                ...
                                <?php foreach ($items as $item) : ?>
                                    ...
                                    <?php if ($data->code_item == $item->code) : ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="qty" id="qty" value="<?= $data->qty; ?>">
                    </div>
                </div>
                <div class="form-group row">
