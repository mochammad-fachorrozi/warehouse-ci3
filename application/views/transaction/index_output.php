        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteItemLabel">Delete Output Item</h5>
                    <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="<?= base_url('transaction/destroyOutput'); ?>" method="post">
...
<?php foreach ($datas as $key => $data) : ?>
    ...
    <div class="modal fade" id="approve<?= $data->code ?>" tabindex="-1" aria-labelledby="aprroveModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="aprroveModal">Approve Output Item</h5>
                    <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="<?= base_url('transaction/approveOutput'); ?>" method="post">
                    <div class="modal-body">
...
<?php foreach ($datas as $key => $data) : ?>
    <div class="modal fade" id="reject<?= $data->code ?>" tabindex="-1" aria-labelledby="deleteItemLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteItemLabel">Reject Output Item</h5>
                    <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="<?= base_url('transaction/rejectOutput'); ?>" method="post">
                    <div class="modal-body">
                        <div class="form-group text-center">
                            <input type="hidden" class="form-control" id="code" name="code" value="<?= $data->code ?>">
