    ...
    class Auth extends CI_Controller
    {
        ...
        private function _sendEmail($token, $type)
        {
            $config = [
                ...
                'smtp_user' => 'bangrozi925@gmail.com',
                'smtp_pass' => 'rozi1998',
                'smtp_port' => 465,
                'mailtype'  => 'html',
                'charset'   => 'utf-8',
            ...
            $this->email->from('bangrozi925@gmail.com', 'Web Programming Uncen');
            $this->email->to($this->input->post('email'));

            if ($type == 'verify') {
                $this->email->subject('Account Verification');
                $this->email->message('Click this link to verifity your account : <a href="' . base_url() . 'auth/verify?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '">Activate</a>');
            } else if ($type == 'forgot') {
